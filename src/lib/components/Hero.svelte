<script>
  ...
  function playPronunciation() {
    ...
    const audioPath = isSlowed ? '/rafitojuan%20(slowed).aac' : '/rafitojuan.aac';
      ...
      <div class="relative z-10 p-6 sm:p-8">
          ...
          <div class="flex-1 text-center sm:text-left mb-2">
            <div class="flex items-center justify-center sm:justify-start gap-2 mb-1">
              ...
              <button 
                ...
                class="transition-colors {isPlaying ? 'text-green-500 animate-pulse' : 'text-zinc-500 hover:text-zinc-300'}" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 text-sm font-mono text-zinc-400">
          ...
          <div class="flex items-start gap-3 md:col-span-2">
            <div class="mt-0.5 p-2 rounded-lg bg-zinc-900 border border-zinc-800 shrink-0">
          ...
          <div class="flex items-center gap-3">
            <div class="p-2 rounded-lg bg-zinc-900 border border-zinc-800 shrink-0">
              <svg class="w-5 h-5 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
